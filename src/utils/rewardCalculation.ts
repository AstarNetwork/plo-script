...
import ksmCrowdloandParticipants from '../../data/ksm-crowdloan/1st/ksm-crowdloan-participants.json';
...
import sdnSnapshot from '../../data/snapshots/sdn-balance-snapshot-753857.json';
import sdnKsmReward from '../../data/ksm-crowdloan/1st/sdn-ksm-crowdloan-reward.json';
